...
# SLURM Directives
#------------------------------------------------------------------
#SBATCH --job-name=IR_Model_Training      # 作业名称：更新为信息检索模型训练
...
#SBATCH --output=/data/horse/ws/zhyu410g-horse_C3VD_data/slurm_logs/ir_model_training_%j.out  # 标准输出
#SBATCH --error=/data/horse/ws/zhyu410g-horse_C3VD_data/slurm_logs/ir_model_training_%j.err   # 标准错误
...
cd ~/Team_project_IR/IR/Traditional_IR/ 

echo "Current working directory for script execution: $(pwd)"
echo "Executing Python script: ir_colonscopy_model.py" # ***脚本名称已更新***
echo "Start time: $(date)"
echo "--------------------------------------------------------"
echo ""

# 运行 Python 脚本
python ir_colonscopy_model.py
